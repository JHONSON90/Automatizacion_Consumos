...
@task
def procesar(ctx, archivo, mes):
    console.rule(f"[bold blue]Inicio de Automatización - {mes}")
...
'''
    ...
    try:
        ...
        console.print(f"   • Hallazgos/HALLAZGOS MES DE {mes} DE 2025.xlsx")
        console.print(f"   • Hallazgos/analisis_cantidades/ANALISIS CANTIDADES MES DE {mes} DE 2025.xlsx")
        console.print(f"   • Hallazgos/variacion_costo/ANALISIS COSTO UNITARIO {mes} DE 2025.xlsx")
        console.print(f"   • Arreglados/CONSUMO PACIENTES DEL MES DE {mes} DE 2025.xlsx")
        ...
        ctx.run(f'python scripst/script_3.py "{mes}"')
