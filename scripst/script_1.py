...
ruta_compras =  r"D:\SIIGO\Compras\enero-diciembre.xlsx"
...
precios_unitarios["Valor Unitario"] = precios_unitarios['suma_valor'] / precios_unitarios['suma_cantidad']


unidos = pd.merge(precios_unitarios, compras, left_on="COD13", right_on='codigo', how='left')
unidos['desviacion'] = (((unidos["valor unitario"] - unidos['Valor Unitario']) / unidos['Valor Unitario']) * 100)
